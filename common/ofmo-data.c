...
static struct _val_carrier_ vc[] = {
    ...
    /*Additional information for VQE options*/
    {"ansatz", P_CHAR, NULL, "VQE Ansatz type"},
    {"threshold", P_CHAR, NULL, "UCCSD ansatz threshold value"},
    {"version", P_CHAR, NULL, "Determines if VQE application follows conventional method."},
};
