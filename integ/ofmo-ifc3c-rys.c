...
extern void ofmo_twoint_core_rys_ssss(
...
int ofmo_ifc3c_rys_ssss(
	...
	for ( ijcs=ijcs0; ijcs<ijcs1; ijcs++ ) {
	    ...
	    //ofmo_twoint_core_rys_ssss( &La, &Lb, &Lc, &Lc,
	    twoint_core_ssss__(
