...
extern void twoint_core_ssss__(
        ...
        double *DINT );
extern void ofmo_twoint_core_rys_psss(
        ...
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_psps(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_ppss(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_ppps(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_pppp(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_dsss(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_dsps(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_dspp(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_dsds(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_dpss(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_dpps(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_dppp(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_dpds(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_dpdp(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_ddss(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_ddps(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_ddpp(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_ddds(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_dddp(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
        const double vxizc[], const double DC[3], const double AC[3],
        double *DINT );
extern void ofmo_twoint_core_rys_dddd(
        const int *pLa, const int *pLb, const int *pLc, const int *pLd,
        const int *nijps, const double vzeta[], const double vdkab[],
        const double vxiza[], const double BA[3],
        const int *nklps, const double veta[], const double vdkcd[],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_psss( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_ppss( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
		    &psp_xiza_mon[klps0], DC,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_dsss( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
		    &psp_xiza_mon[klps0], DC,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_dpss( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
		    &psp_xiza_mon[klps0], DC,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_ddss( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
		    &psp_xiza_mon[klps0], DC,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_psps( &La, &Lb, &Lc, &Lc,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
		    &psp_xiza_frg[ijps0], BA,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_ppps( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
		    &psp_xiza_mon[klps0], DC,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_dsps( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
		    &psp_xiza_mon[klps0], DC,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_dpps( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
		    &psp_xiza_mon[klps0], DC,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_ddps( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
		    &psp_xiza_mon[klps0], DC,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_pppp( &La, &Lb, &Lc, &Lc,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
		    &psp_xiza_frg[ijps0], BA,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_dspp( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
		    &psp_xiza_mon[klps0], DC,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_dppp( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
		    &psp_xiza_mon[klps0], DC,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_ddpp( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
		    &psp_xiza_mon[klps0], DC,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_dsds( &La, &Lb, &Lc, &Lc,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
		    &psp_xiza_frg[ijps0], BA,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_dpds( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
		    &psp_xiza_mon[klps0], DC,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_ddds( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
		    &psp_xiza_mon[klps0], DC,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_dpdp( &La, &Lb, &Lc, &Lc,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
		    &psp_xiza_frg[ijps0], BA,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_dddp( &La, &Lb, &Lc, &Lc,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
		    &psp_xiza_mon[klps0], DC,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
...
//#pragma omp for schedule(guided)
	for ( klcs=klcs0; klcs<klcs1; klcs++ ) {
	    ...
	    ofmo_twoint_core_rys_dddd( &La, &Lb, &Lc, &Lc,
		    &nijps, &psp_zeta_frg[ijps0], &psp_dkps_frg[ijps0],
		    &psp_xiza_frg[ijps0], BA,
		    &nklps, &psp_zeta_mon[klps0], &psp_dkps_mon[klps0],
