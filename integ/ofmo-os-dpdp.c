...
static void ofmo_hrr_calc_dpdp(
...
static void ofmo_vrr_calc_dpdp(
...
static void ofmo_vrr_cint_dpdp( const double *ev, double *eh ) {
    ...
    for ( ijps=0; ijps<(*nijps); ijps++ ) {
        ...
        for ( klps=0; klps<(*nklps); klps++ ) {
            ...
            ofmo_vrr_calc_dpdp(
                    ...
                    ev );
            ofmo_vrr_cint_dpdp( ev, eh );
        }	// for (klps)
    }	// for (ijps)
    ofmo_hrr_calc_dpdp( BA, DC, eh );
