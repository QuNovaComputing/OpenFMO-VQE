...
extern int ofmo_vqe_call( const int mythread, const int nmonomer, const int monomer_list[], const int nao, const double H[],
    ...
    const double energy, const int iscc, const double ev[], char * desc, const int homo, const int lumo, const int ent, double D[]);

extern int ofmo_vqe_get_amplitudes( const int ifrag, const int iscc, const int nao, int * namps, double ** amp, char *** fock,
...
extern int ofmo_vqe_posthf_density( const int na, const double * A, char ** fock_vec, const double corr_mat[],
